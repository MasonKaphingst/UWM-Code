...
CS250
Lab 11
This program generates a list of random numbers between 1-100 and then sorts them and then finds how many times it sorted the array.

*/


import java.util.Scanner;
public class Lab11CS250{
    public static void main(String[] args){
        ...
        printArray(scores, Size);
        System.out.println("\n");
        System.out.println(sortArray(runTimes));
        stdIn.close();
    }
    ...
    public static void sortArray(double [] arr, int eSize, int runTimes){
        int x = runTimes;
        for (int i = 0; i < eSize; ++i){
